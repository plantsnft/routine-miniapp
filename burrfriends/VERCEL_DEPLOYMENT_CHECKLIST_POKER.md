# Vercel Deployment Checklist (Poker)

> **Note:** This checklist is for the **poker** Vercel project. For **burrfriends** deployment, see **Infrastructure, Deployment, and External Services** in BURRFRIENDS_GAME_SETUP_PHASED_PLAN_REVISED.md.
