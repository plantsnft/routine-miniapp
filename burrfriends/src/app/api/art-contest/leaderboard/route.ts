/**
 * GET /api/art-contest/leaderboard
 * All submissions for the active contest (or ?contestId=) with submitter name and cast link.
 */
  ...
  try {
    ...
    if (fids.length > 0) {
      try {
        ...
        console.warn("[art-contest/leaderboard] fetchBulkUsers failed:", e);
      }
    }
    ...
    console.error("[art-contest/leaderboard GET]", e);
