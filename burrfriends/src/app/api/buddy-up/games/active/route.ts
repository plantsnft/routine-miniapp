/**
 * GET /api/buddy-up/games/active - Get active games (signup or in_progress)
 */
...
export async function GET(_req: NextRequest) {
  try {
    ...
    const inProgress = await pokerDb.fetch<any>("buddy_up_games", {
    ...
    console.error("[buddy-up/games/active GET]", e);
