/**
 * POST /api/bullied/games/[id]/end - Manually end game (admin only)
...
export async function POST(
  ...
  try {
    ...
    await pokerDb.update("bullied_games", { id: gameId }, { status: newStatus, updated_at: now });
    ...
    console.error("[bullied/games/[id]/end POST]", e);
