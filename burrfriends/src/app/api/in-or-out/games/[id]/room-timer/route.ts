/**
 * PATCH /api/in-or-out/games/[id]/room-timer - Set countdown end time (admin only)
 * Body: { minutes: number }. Game must be in_progress.
 */
...
export async function PATCH(
  ...
  try {
    ...
    console.error("[in-or-out/games/[id]/room-timer PATCH]", e);
