/**
 * POST /api/nl-holdem/games/[id]/settle - Mark game settled (admin only).
 * Phase 40. Full play/settlement logic (winners, payouts) to be added later.
 */
...
export async function POST(
  ...
  try {
    ...
    await pokerDb.update("nl_holdem_games", { id: gameId }, { status: "settled", updated_at: now });
    ...
    console.error("[nl-holdem/games/[id]/settle POST]", e);
