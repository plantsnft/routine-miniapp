/**
 * POST /api/remix-betr/rounds/[id]/close - Close round (admin only)
 * Plan 12.5, 12.13: set status to 'closed', set closed_at. Only when status is 'open'.
 */
...
export async function POST(
  ...
  try {
    ...
    console.error("[remix-betr/rounds/[id]/close POST]", e);
