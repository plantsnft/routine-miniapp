/**
 * POST /api/superbowl-squares/games/[id]/cancel - Cancel game (admin only)
 */
...
export async function POST(
  ...
  try {
    ...
    const games = await pokerDb.fetch<{ id: string; status: string }>("superbowl_squares_games", {
      filters: { id: gameId },
      limit: 1,
    });
    ...
    await pokerDb.update("superbowl_squares_games", { id: gameId }, {
      status: "cancelled",
    ...
    console.error("[superbowl-squares/games/[id]/cancel POST]", e);
