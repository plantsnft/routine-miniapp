/**
 * POST /api/the-mole/games/[id]/vote - Submit vote (who you think is the mole)
...
export async function POST(
  ...
  try {
    ...
    const existing = await pokerDb.fetch<{ id: string }>("mole_votes", {
    ...
    await pokerDb.insert("mole_votes", [
      {
        group_id: groupId,
        voter_fid: fid,
    ...
    console.error("[the-mole/games/[id]/vote POST]", e);
