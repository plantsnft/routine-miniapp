...
export function ScrollingBanner() {
  ...
  const bannerItems = useMemo(() => {
    const message1 = 'Welcome to BETR WITH BURR';
    const message2 = 'Add the mini app with notifications on for notification of new games.';
    const message3 = 'Join games below';
    const message4 = 'BETR WITH BURR mini-app does not take any cuts or fees to provide its service. This is 100% free and is not to be used for gambling purposes. Please review your local laws';
    const message5 = 'Upcoming: BETR March Madness Basketball';
    ...
    const pokerChip = (
      ...
      >
        <circle cx="7" cy="7" r="6.5" fill="#14B8A6" stroke="#0F766E" strokeWidth="0.5" />
        <circle cx="7" cy="7" r="4.5" fill="none" stroke="#0F766E" strokeWidth="0.3" opacity="0.6" />
        <circle cx="7" cy="7" r="2" fill="none" stroke="#0F766E" strokeWidth="0.2" opacity="0.4" />
      </svg>
    );
