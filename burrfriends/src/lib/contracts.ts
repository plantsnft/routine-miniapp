...
// BurrfriendsGameEscrow contract ABI (minimal interface for frontend)
export const GAME_ESCROW_ABI = [
    ...
    outputs: [
      {
        ...
        internalType: 'struct BurrfriendsGameEscrow.Game',
        name: '',
        type: 'tuple',
      },
    ],
  ...
  },
  {
    inputs: [
      { internalType: 'address[]', name: 'recipients', type: 'address[]' },
      { internalType: 'uint256[]', name: 'baseAmountsWei', type: 'uint256[]' },
      { internalType: 'bool', name: 'applyMultipliers', type: 'bool' },
      { internalType: 'bool', name: 'doubleIfBB', type: 'bool' },
    ],
    name: 'getTournamentPayouts',
    outputs: [{ internalType: 'uint256[]', name: '', type: 'uint256[]' }],
    stateMutability: 'view',
    type: 'function',
  },
